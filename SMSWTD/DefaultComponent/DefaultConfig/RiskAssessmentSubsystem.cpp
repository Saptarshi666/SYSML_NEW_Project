...
RiskAssessmentSubsystem::RiskAssessmentSubsystem(void) {
    NOTIFY_CONSTRUCTOR(RiskAssessmentSubsystem, RiskAssessmentSubsystem(), 0, SMSWTD_Architecture_RiskAssessmentSubsystem_RiskAssessmentSubsystem_SERIALIZE);
}
...
#ifdef _OMINSTRUMENT
IMPLEMENT_META_P(RiskAssessmentSubsystem, SMSWTD_Architecture, SMSWTD_Architecture, false, OMAnimatedRiskAssessmentSubsystem)
#endif // _OMINSTRUMENT
